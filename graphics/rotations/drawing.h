...
/* Constants for different modes in the free scene */
#define FREE_SQUARE_ROT         0
#define FREE_METEOR_SPACE       1

/* The current display mode for free mode */
extern int free_scene_mode;

/* The current display mode */
extern int disp_mode;

/* Extra in Display Mode 7 */
